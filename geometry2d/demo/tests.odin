...
test_intersects::proc(){
    ...
    _, point_count = geometry2d.intersects_rectangle_triangle({2000., 2000., 2000., 2000.,}, {{1900., 3500.}, {2100., 1990.}, {4100., 4100.}, })
    ...
    _, point_count = geometry2d.intersects_triangle_line({{1000., 1000.}, {3000., 1000.}, {2000., 3000.}, }, {1500., 900., 1500., 3000.,})
    append_result(&intersects_results, {name = "Triangle: Line 1",      result = point_count == 2})
    _, point_count = geometry2d.intersects_triangle_line({{1000., 1000.}, {3000., 1000.}, {2000., 3000.}, }, {1000., 1000.01, 3000., 1000.01,})
    append_result(&intersects_results, {name = "Triangle: Line 2",      result = point_count == 2})
    _, point_count = geometry2d.intersects_triangle_circle({{1000., 1000.}, {3000., 1000.}, {2000., 3000.}, }, {2000., 3000., 1000.,})
    append_result(&intersects_results, {name = "Triangle: Circle 1",    result = point_count == 2})
    _, point_count = geometry2d.intersects_triangle_circle({{1000., 1000.}, {3000., 1000.}, {2000., 3000.}, }, {3000., 3000., 4000.,})
    append_result(&intersects_results, {name = "Triangle: Circle 2",    result = point_count == 0})
    _, point_count = geometry2d.intersects_triangle_rectangle({{1900., 3500.}, {2100., 1990.}, {4100., 4100.}, }, {2000., 2000., 2000., 2000.,})
    append_result(&intersects_results, {name = "Triangle: Rectangle 1", result = point_count == 6})
    _, point_count = geometry2d.intersects_triangle_rectangle({{1900., 3500.}, {2100., 1990.}, {1000., 1000.}, }, {2000., 2000., 2000., 2000.,})
