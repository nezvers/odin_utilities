...
test_intersects::proc(){
    ...
    _, point_count = geometry2d.intersects_line_line({2000., 2000., 4000., 2000.,}, {1000., 3000., 5000., 2000.,})
    append_result(&intersects_results, {name = "Line: Line 3",          result = point_count == 0})
    _, point_count = geometry2d.intersects_line_line({2000., 2000., 2000., 4000.,}, {1000., 3000., 5000., 2000.,})
    append_result(&intersects_results, {name = "Line: Line 4",          result = point_count == 1})
    _, point_count = geometry2d.intersects_line_line({4000., 2000., 4000., 4000.,}, {1000., 3000., 5000., 2000.,})
    append_result(&intersects_results, {name = "Line: Line 5",          result = point_count == 1})
    _, point_count = geometry2d.intersects_line_line({2000., 4000., 4000., 4000.,}, {1000., 3000., 5000., 2000.,})
