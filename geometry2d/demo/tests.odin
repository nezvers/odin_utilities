...
test_intersects::proc(){
    ...
    append_result(&intersects_results, {name = "Line: Line 1",          result = point_count == 1})
    ...
    append_result(&intersects_results, {name = "Rectangle: Point 1",    result = false}) //geometry2d.intersects_rectangle_point({1000., 1000., 3000., 3000.,}, {3090., 4000.})})
    append_result(&intersects_results, {name = "Rectangle: Point 2",    result = false}) //!geometry2d.intersects_rectangle_point({1000., 1000., 3000., 3000.,}, {4000., 4000.001})})
    append_result(&intersects_results, {name = "Rectangle: Line 1",     result = false}) //geometry2d.intersects_rectangle_line({1000., 1000., 3000., 3000.,}, {1000., 1000., 4000., 4000.,})})
    append_result(&intersects_results, {name = "Rectangle: Line 2",     result = false}) //geometry2d.intersects_rectangle_line({1000., 1000., 3000., 3000.,}, {1000., 1000., 4000., 1000.,})})
    append_result(&intersects_results, {name = "Rectangle: Line 3",     result = false}) //!geometry2d.intersects_rectangle_line({1000., 1000., 3000., 3000.,}, {1000., 1000., 4000.01, 1000.,})})
