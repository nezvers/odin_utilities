...
atlas_buffer:[ATLAS_SIZE.x * ATLAS_SIZE.y + 1]Vec2
...
unload_assets :: proc() {
    karl2d.destroy_texture(tileset_texture)
}

create_tiles :: proc() {
	tile_size:Vec2 = {cast(f32)TILE_SIZE.x, cast(f32)TILE_SIZE.y}
